...
h=uicontrol('Parent',fig,'Style','text','String','Datadir',...
   'Position',pos);
h=uicontrol('Parent',fig,'Style','edit','Enable','on','String',[pwd '\'],'Tag','ms_Datadir',...
...
%========= Save Data As... and Load Data pushbuttons ==================
pos=pos-oneline;  
h=uicontrol('Parent',fig,'Style','text','String','base file str',...
   'Position',pos);
h=uicontrol('Parent',fig,'Style','edit','Enable','on','String','SEQ_',...
   'Position',pos+[pos(3) 0 2*pos(3) interlines],'Tag','ms_BsFlStr',...
   'HorizontalAlignment','left',...
	'BackgroundColor',white);
...
h=uicontrol('Parent',fig,'Style','popupmenu','String',{'single crystal'},...%,'powder'},...
   ...
   'Callback','ms_sample_SNS','Value',1);
