function data_out=calcproj_SNS(data_in)

% data_in.a, b, c (1,3)[�] = direct criystal lattice
...
data_out.axis_unitlength=[unitlength1; unitlength2; unitlength3];
	...
	%this is the function to replace with a multiplication of the U matrix 
	% === transform wavevector Q into sample reference frame by a rotation of the coordinate system
	Q=sqe2samp(data_in.Q,data_in.psi_samp); % Q(ndet,ne,3) [�^{-1}]	
