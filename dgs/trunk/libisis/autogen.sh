...
#LIBTOOLIZE="$libtoolize --force --copy --automake --ltdl"
...
case $autoconfversion in
    ...
    *[3-9].*)
	;;
    *)
	echo "This autoconf version is not supported by LIBISIS."
	exit
	;;
esac
...
case $automakeversion in
    ...
    *1.1[0-9]*)
	;;
    *)
	echo "This automake version is not supported by LIBISIS."
	exit
	;;
esac
...
case $libtoolversion in
    ...
    *[2-9].*)
	;;
    *)
	echo "This libtool version is not supported by LIBISIS."
	exit
	;;
esac
