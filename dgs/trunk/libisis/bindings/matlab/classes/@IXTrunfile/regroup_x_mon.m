function runfile_out = regroup_x_mon(runfile_in,regroup_parameter)
%
% new_runfile = regroup_x_mon(runfile,params)
%
...
runfile_out= libisisexc('IXTrunfile','regroup_x_mon',IXTrunfile,runfile_in,regroup_parameter);
