function [fig_out, axes_out, plot_out] = ploc(w,varargin)
%-----help for gtk line overplot command pl--------------------------------
%function syntax: PLOC(1ddataset_object,[property_name,property_value])
...
[figureHandle_, axesHandle_, plotHandle_] = pl(w, 'name', name, 'tag', tag, varargin{:});
