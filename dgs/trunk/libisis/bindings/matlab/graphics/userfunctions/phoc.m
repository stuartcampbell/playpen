function [fig_out, axes_out, plot_out] = phoc(w,varargin)
%--------------------------------------------------------------------------
%function syntax: PHOC(1ddataset_object,[property_name,property_value])
...
[figureHandle_, axesHandle_, plotHandle_] = ph(w, 'name', name, 'tag', tag, varargin{:});
