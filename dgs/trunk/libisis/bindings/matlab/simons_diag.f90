 subroutine IXBdiag_simon(nlhs, plhs, nrhs, prhs, status)
    use IXMlibcore
    use IXMm_dataset_1d
    use IXMm_dataset_2d
    use IXMm_datum
	...
	integer,allocatable :: good_det(:), bad_det(:) 
...
!subroutine van_integral(x,s,e)

!end subroutine van_integral
