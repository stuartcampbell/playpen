...
real(dp)::d_int(2),energy,rebin_array(3),ei(2)
...
rebin_array=(/-10.0, 3.0, 400.0 /)
energy=450.0
white_beam_number='mydata:::MER00579.RAW'
sample_number='mydata:::MER00603.RAW'
detmap='mymaps:::rings_map.map'
...
write(6,*) 'Starting Merlin HOMER test  program'
...
call IXFadditem_data_source(dso,'mymaps:::merlin_monitors.map','monmapfile','undefined',status)
...
call IXFadditem_data_source(dso,'mymaps:::rings_map.map','detmapfile','undefined',status)
