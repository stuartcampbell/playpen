...
# print final histograms as ISAW ascii files
inp_name = '%i_obs%s' %(run_number,'.out')
inp_file = open(output_folder+inp_name, 'w')
inp_file.write('Observed data histogram\n')
inp_file.write('d\n')
inp_file.write('d_space\n')
inp_file.write('Counts\n')
inp_file.write('Scattering Intensity\n')
inp_file.write('%i \n' %(nd2))
for k in xrange(nd2):
    inp_file.write('%f %f \n' %(dbins[k], totdhist[k]))
inp_file.write('%f \n' %(dbins[nd2]))
inp_file.close()
inp_name = '%i_ghost%s' %(run_number,'.out')
inp_file = open(output_folder+inp_name, 'w')
inp_file.write('Ghost data histogram\n')
inp_file.write('d\n')
inp_file.write('d_space\n')
inp_file.write('Counts\n')
inp_file.write('Scattering Intensity\n')
...
inp_file.write('%f \n' %(dbins[nd2]))
inp_file.close()
inp_name = '%i_corr%s' %(run_number,'.out')
inp_file = open(output_folder+inp_name, 'w')
inp_file.write('Corrected data histogram\n')
inp_file.write('d\n')
inp_file.write('d_space\n')
inp_file.write('Counts\n')
inp_file.write('Scattering Intensity\n')
